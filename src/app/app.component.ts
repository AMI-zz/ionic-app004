...
export class ConferenceApp {
  ...
  appPages: PageInterface[] = [
    { title: '执业医师', name: 'TabsPage', component: TabsPage, tabComponent: SchedulePage, index: 0, icon: 'calendar' },
    { title: '朋友圈', name: 'TabsPage', component: TabsPage, tabComponent: SpeakerListPage, index: 1, icon: 'contacts' },
    { title: '个人申请', name: 'TabsPage', component: TabsPage, tabComponent: MapPage, index: 2, icon: 'map' },
